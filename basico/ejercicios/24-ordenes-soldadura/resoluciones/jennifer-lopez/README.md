...
Vas a construir una solucion MongoDB para un caso de soldadura. El ejercicio se enfoca en estados de inspeccion, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_ordenes_soldadura`.
...
```text
basico/ejercicios/24-ordenes-soldadura/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
