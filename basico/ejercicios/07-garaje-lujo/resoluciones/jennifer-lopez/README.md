...
Vas a construir una solucion MongoDB para un caso de autos de lujo. El ejercicio se enfoca en filtros numericos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_garaje_lujo`.
...
```text
basico/ejercicios/07-garaje-lujo/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
