...
Vas a construir una solucion MongoDB para un caso de tecnologia. El ejercicio se enfoca en schema validation introductorio, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_validacion_basica`.
...
```text
basico/ejercicios/29-validacion-basica/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
