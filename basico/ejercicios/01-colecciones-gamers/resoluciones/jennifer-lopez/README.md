...
Vas a construir una solucion MongoDB para un caso de videojuegos shooters. El ejercicio se enfoca en crear base de datos, colecciones y documentos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_colecciones_gamers`.
...
```text
basico/ejercicios/01-colecciones-gamers/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
