...
Vas a construir una solucion MongoDB para un caso de autos y motos. El ejercicio se enfoca en stock y alertas, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_inventario_ecommerce`.
...
```text
basico/ejercicios/26-inventario-ecommerce/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
