...
Vas a construir una solucion MongoDB para un caso de turismo. El ejercicio se enfoca en documentos geograficos simples, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_rutas_turisticas`.
...
```text
basico/ejercicios/18-rutas-turisticas/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
