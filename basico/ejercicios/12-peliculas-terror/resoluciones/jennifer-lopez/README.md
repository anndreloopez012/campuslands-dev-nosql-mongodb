...
Vas a construir una solucion MongoDB para un caso de peliculas de miedo. El ejercicio se enfoca en filtros por texto y rating, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_peliculas_terror`.
...
```text
basico/ejercicios/12-peliculas-terror/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
