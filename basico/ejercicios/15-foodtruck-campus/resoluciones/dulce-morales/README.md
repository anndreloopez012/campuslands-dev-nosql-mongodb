...
Vas a construir una solucion MongoDB para un caso de comida. El ejercicio se enfoca en insert y update de pedidos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_foodtruck_campus`.
...
```text
basico/ejercicios/15-foodtruck-campus/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
