...
Vas a construir una solucion MongoDB para un caso de peliculas y musica. El ejercicio se enfoca en documentos de usuario, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_usuarios_streaming`.
...
```text
basico/ejercicios/27-usuarios-streaming/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
