...
// Consulta 2: Buscar personajes con alto poder magico usando el documento anidado

db.personajes.find({ "atributos.magia": { $gt: 50}});

// Consulta 3: Buscar heroes que tengan al menos un objeto de rarera "Epica" dentro de su array de equipamiento

db.personajes.find({ "equipamiento.rareza": "Épica" });
