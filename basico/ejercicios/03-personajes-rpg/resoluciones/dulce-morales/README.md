...
Vas a construir una solucion MongoDB para un caso de videojuegos RPG. El ejercicio se enfoca en documentos anidados, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_personajes_rpg`.
...
```text
basico/ejercicios/03-personajes-rpg/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
