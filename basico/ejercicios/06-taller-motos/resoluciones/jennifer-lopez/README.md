...
Vas a construir una solucion MongoDB para un caso de mecanica de motos. El ejercicio se enfoca en updates basicos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_taller_motos`.
...
```text
basico/ejercicios/06-taller-motos/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
