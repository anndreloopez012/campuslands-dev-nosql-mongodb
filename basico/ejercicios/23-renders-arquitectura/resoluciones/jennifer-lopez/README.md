...
Vas a construir una solucion MongoDB para un caso de diseno 3D arquitectura. El ejercicio se enfoca en consultas por cliente, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_renders_arquitectura`.
...
```text
basico/ejercicios/23-renders-arquitectura/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
