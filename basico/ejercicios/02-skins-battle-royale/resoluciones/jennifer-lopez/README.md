...
Vas a construir una solucion MongoDB para un caso de videojuegos battle royale. El ejercicio se enfoca en insertMany y documentos simples, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_skins_battle_royale`.
...
```text
basico/ejercicios/02-skins-battle-royale/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
