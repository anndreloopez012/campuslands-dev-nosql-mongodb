...
Vas a construir una solucion MongoDB para un caso de tatuajes. El ejercicio se enfoca en estados y fechas, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_tattoo_agenda`.
...
```text
basico/ejercicios/20-tattoo-agenda/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
