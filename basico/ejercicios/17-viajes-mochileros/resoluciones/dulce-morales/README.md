...
Vas a construir una solucion MongoDB para un caso de viajes. El ejercicio se enfoca en fechas y presupuesto, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_viajes_mochileros`.
...
```text
basico/ejercicios/17-viajes-mochileros/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
