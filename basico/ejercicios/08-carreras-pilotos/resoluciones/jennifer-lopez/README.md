...
Vas a construir una solucion MongoDB para un caso de carreras. El ejercicio se enfoca en sort y limit, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_carreras_pilotos`.
...
```text
basico/ejercicios/08-carreras-pilotos/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
