...
Vas a construir una solucion MongoDB para un caso de libros. El ejercicio se enfoca en proyecciones limpias, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_biblioteca_tech`.
...
```text
basico/ejercicios/14-biblioteca-tech/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
