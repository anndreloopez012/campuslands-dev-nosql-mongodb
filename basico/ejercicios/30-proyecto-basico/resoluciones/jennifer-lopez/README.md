...
videojuegos y campus

## Contexto del problema

Vas a construir una solucion MongoDB para un caso de videojuegos y campus. El ejercicio se enfoca en integracion CRUD, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_proyecto_basico`.
...
```text
basico/ejercicios/30-proyecto-basico/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
