...
Vas a construir una solucion MongoDB para un caso de videojuegos MOBA. El ejercicio se enfoca en filtros simples, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_heroes_moba`.
...
```text
basico/ejercicios/04-heroes-moba/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
