...
Vas a construir una solucion MongoDB para un caso de pingpong. El ejercicio se enfoca en conteo y busqueda, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_pingpong_campus`.
...
```text
basico/ejercicios/10-pingpong-campus/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
