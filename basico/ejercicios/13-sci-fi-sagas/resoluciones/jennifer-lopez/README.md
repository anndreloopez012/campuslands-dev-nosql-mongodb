...
Vas a construir una solucion MongoDB para un caso de ciencia ficcion. El ejercicio se enfoca en referencias manuales, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_sci_fi_sagas`.
...
```text
basico/ejercicios/13-sci-fi-sagas/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
