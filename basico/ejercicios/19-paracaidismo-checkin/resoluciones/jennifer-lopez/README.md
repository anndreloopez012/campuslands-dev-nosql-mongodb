...
Vas a construir una solucion MongoDB para un caso de paracaidismo. El ejercicio se enfoca en validaciones manuales, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_paracaidismo_checkin`.
...
```text
basico/ejercicios/19-paracaidismo-checkin/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
