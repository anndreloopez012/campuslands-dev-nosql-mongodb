...
Vas a construir una solucion MongoDB para un caso de formulas quimicas. El ejercicio se enfoca en arrays de componentes, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_formulas_lab`.
...
```text
basico/ejercicios/25-formulas-lab/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
