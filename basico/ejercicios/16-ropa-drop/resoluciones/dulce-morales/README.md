...
Vas a construir una solucion MongoDB para un caso de ropa. El ejercicio se enfoca en arrays de tallas, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_ropa_drop`.
...
```text
basico/ejercicios/16-ropa-drop/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
