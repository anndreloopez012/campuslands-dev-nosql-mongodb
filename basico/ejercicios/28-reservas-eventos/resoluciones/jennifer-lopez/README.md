...
Vas a construir una solucion MongoDB para un caso de deportes. El ejercicio se enfoca en delete controlado, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_reservas_eventos`.
...
```text
basico/ejercicios/28-reservas-eventos/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
