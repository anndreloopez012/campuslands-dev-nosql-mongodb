...
Vas a construir una solucion MongoDB para un caso de kickboxing. El ejercicio se enfoca en operadores logicos, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_kickboxing_ranking`.
...
```text
basico/ejercicios/09-kickboxing-ranking/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
