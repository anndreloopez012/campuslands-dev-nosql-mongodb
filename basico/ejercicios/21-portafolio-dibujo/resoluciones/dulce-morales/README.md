...
Vas a construir una solucion MongoDB para un caso de dibujo. El ejercicio se enfoca en tags y busqueda, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_portafolio_dibujo`.
...
```text
basico/ejercicios/21-portafolio-dibujo/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
