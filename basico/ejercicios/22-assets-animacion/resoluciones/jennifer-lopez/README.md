...
Vas a construir una solucion MongoDB para un caso de animacion 3D. El ejercicio se enfoca en documentos con estado, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_assets_animacion`.
...
```text
basico/ejercicios/22-assets-animacion/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
