...
Vas a construir una solucion MongoDB para un caso de musica. El ejercicio se enfoca en arrays simples, usando datos realistas y consultas que respondan preguntas utiles.
...
3. Crea la base de datos `campus_playlist_musica`.
...
```text
basico/ejercicios/11-playlist-musica/resoluciones/nombre-apellido/
├── README.md
├── seed.mongodb.js
├── queries.mongodb.js
└── evidencias.md
